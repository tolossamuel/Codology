...
function SideBar() {
  return (
    <div className=" flex flex-col  w-64 bg-purple-500  border-2 bg-gradient-to-tr from-purple-800 rounded-lg border-gray-50  mx-3">
      ...
      <ul className="flex flex-col py-4 space-y-4">
        ...
        <li>
          ...
          >
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Resource</span>
        ...
        <li>
          ...
          >
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Schedule</span>
